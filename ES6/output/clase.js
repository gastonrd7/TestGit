...
var Estudiante = /*#__PURE__*/function (_usuario) {
  ...
  function Estudiante(nombre, edad, carrera) {
    ...
    _this = _super.call(this, nombre, edad);
  ...
  _createClass(Estudiante, [{
    key: "mostrarInfo",
    value: function mostrarInfo() {
      return "".concat(this.nombre, ", tiene ").concat(this.edad, " y es: ").concat(this.carrera, " ");
    }
  }]);

  return Estudiante;
}(usuario); //Instancio la clase usuario.
...
var nombreUsuario = new Estudiante('Martin', 40, 'Programador');
document.write(nombreUsuario.mostrarInfo());